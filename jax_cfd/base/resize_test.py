...
class ResizeTest(test_util.TestCase):
  ...
  def testDownsampleFourierVorticity(self):
    ...
    with self.subTest('Space2D'):
      ...
      fine_to_medium = resize.downsample_vorticity_hat(
          None, medium, fine_signal_hat)
      medium_to_coarse = resize.downsample_vorticity_hat(
          None, coarse, fine_to_medium)
      fine_to_coarse = resize.downsample_vorticity_hat(
      ...
      self.assertAllClose(
          fine_signal_hat,
          resize.downsample_vorticity_hat(None, fine, fine_signal_hat))

      self.assertAllClose(
          fine_to_medium,
          resize.downsample_vorticity_hat(None, medium, fine_to_medium))
    ...
    with self.subTest('DownsampleWavenumbers'):
      ...
      # (256/64)^2 = 16
      kx_down = 16 * resize.downsample_vorticity_hat(None, coarse, kx_fine)
      ky_down = 16 * resize.downsample_vorticity_hat(None, coarse, ky_fine)
